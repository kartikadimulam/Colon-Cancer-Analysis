...
# After adding differ we got an AIC of 6458.958.
```
...
# By using BIC, we can see that the previous model, without obstruct, is a better model as it gives a BIC of 5462.657. 
```
